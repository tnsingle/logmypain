...
import com.apps.headache.record.Dialogs.AddTriggersDialogFragment;
import com.apps.headache.record.Dialogs.DateTimeDialogFragment;
import com.apps.logmypain.R;
import com.apps.logmypain.R.layout;
import com.apps.logmypain_dev.ViewRecordsActivity;
...
implements DateTimeDialogFragment.DateTimeDialogListener, AddTriggersDialogFragment.AddTriggersDialogListener{
	...
	private void initializeFormFields(){
        ...
        if(id > -1){
	        this.record = this.db.getHeadache(id);
...
public void saveRecord(View view) {
        ...
        if(record.getId() > -1)
        	db.updateHeadache(record);
        else
        	db.addHeadache(record);
